 ...
 * {@link LongTermPage.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LongTermPage#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LongTermPage extends Fragment {
     ...
     * @return A new instance of fragment LongTermPage.
     */
    // TODO: Rename and change types and number of parameters
    public static LongTermPage newInstance(String param1, String param2) {
        LongTermPage fragment = new LongTermPage();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_long_term_page, container, false);
        TabHost tabHost = (TabHost)rootView.findViewById(R.id.longTermTabHost);
        tabHost.setup();
        FloatingActionButton fab = (FloatingActionButton)getActivity().findViewById(R.id.fab);
        fab.setVisibility(View.VISIBLE);
        TextView overlayCommonContent = (TextView)rootView.findViewById(R.id.commonContentLongTermOverlay);
        TextView markersCommonContent = (TextView)rootView.findViewById(R.id.commonContentLongTermMarkers);
        TextView overlayTitle = (TextView)rootView.findViewById(R.id.longTermOverlayTitle);
        TextView markersTitle = (TextView)rootView.findViewById(R.id.longTermMarkersTitle);
        ...
        if (overlay.equals("AIRS_CO_Total_Column_Day")){
            ...
            overlayCommonContent.setText(R.string.coLongTerm);
        }

        else if (overlay.equals("MLS_O3_46hPa_Day")){
            overlayTitle.setText(R.string.ozone);
            overlayCommonContent.setText(R.string.ozoneLongTerm);
        }
            ...
            overlayCommonContent.setText(R.string.humidityLongTerm);
        }
        ...
        if (markers.equals("usepa-aqi")){
            ...
            markersCommonContent.setText(R.string.compositeLongTerm);
        }
            ...
            markersCommonContent.setText(R.string.ozoneLongTerm);
        }

        else if (markers.equals("usepa-so2")){
            markersTitle.setText(R.string.so2);
            markersCommonContent.setText(R.string.so2LongTerm);
        }

        else if (markers.equals("usepa-co")){
            markersTitle.setText(R.string.carbonMonoxide);
            markersCommonContent.setText(R.string.coLongTerm);
        }
        else{
        ...
        spec.setContent(R.id.longTermOverlayTab);
        tabHost.addTab(spec);

        spec = tabHost.newTabSpec("markers");
        spec.setIndicator("Markers");
        spec.setContent(R.id.longTermMarkersTab);
        tabHost.addTab(spec);
